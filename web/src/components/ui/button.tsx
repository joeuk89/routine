...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-md active:scale-95 focus-visible:ring-2",
        destructive:
        ...
        outline:
          "border border-gray-300 bg-background shadow-sm hover:bg-gray-50 hover:border-gray-400 hover:shadow-md active:scale-95 dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
        ...
        "primary-gradient":
          "bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md hover:from-blue-700 hover:to-blue-800 hover:shadow-lg active:scale-95 focus-visible:ring-2 focus-visible:ring-blue-500/50",
        "success":
          "bg-green-600 text-white shadow-sm hover:bg-green-700 hover:shadow-md active:scale-95 focus-visible:ring-2 focus-visible:ring-green-500/50",
      },
      size: {
